...
/* 
 Include file for E_i2c.c
 Description			:   Include file for i2c  interface
...
#define  I2C_PORT   PORTC   // Move to CPU 
...
void i2c_receive_byte(uint8_t ackFlag);
//! Pick up the data that was received with i2cReceiveByte()
uint8_t i2c_get_receivedbyte(void);
