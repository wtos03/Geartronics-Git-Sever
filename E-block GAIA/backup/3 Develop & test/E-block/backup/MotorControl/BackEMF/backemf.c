/*
 ...
 Module 				:   BackEMF Module
 Description 			:   BackEMF measure and calculate Module 
 Original written for 	:   ATMEGA32
 CPU port/tested		:   ATMEGA32
 Hardware use			:   TISN754410 Quad Half H-Driver
 ...
 Date			By 					Comments
 ----			--					---------
 15/8/2006     Wichai			Initial Version 1.0
...
volatile uint8_t  g_status[MOTOR_MAX] = {0,0};   // Forchecking in program_run
// ------ UART
...
uint8_t  g_program_buff[MAX_PROGRAM] =  {""};
