...
*
* - Modified by Wichai Tossamartvorakul 23/8/2006  To change checking booloader condition 
*   By press two switch on PD3,PC2 at once  ( For E-block I/O project)
* 
****************************************************************************
*
...
#define BLPORT1  PORTC
#define BLDDR1   DDRC
#define BLPIN1   PINC
#define BLPNUM1  PINC2

// Add another SW
#define BLPORT2  PORTD
#define BLDDR2   DDRD
#define BLPIN2   PIND
#define BLPNUM2  PIND3
